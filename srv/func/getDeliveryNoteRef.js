...
module.exports = async (request, tx) => {
    ...
    const oResultDeliveryNoteRefRequest = await serviceRequestS4_HANA.get(process.env['Path_API_YY1_INBOUNDDELIVERIES_CDS']+"&$filter=Supplier eq '"+supplier+"' and DeliveryDocumentBySupplier ne ''");
