...
module.exports = async (request, tx) => {
    ...
    if (valid) {
        ...
        LockUser = LockUser == null || LockUser == '' ? request.req.authInfo.getEmail() : LockUser;
        ...
        try {
            ...
            result.lockedBy = data[0].LockedBy !== null ? data[0].LockedBy : request.req.authInfo.getEmail();
